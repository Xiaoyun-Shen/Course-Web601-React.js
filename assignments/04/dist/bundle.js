...
var Pokemon = function (_React$Component) {
    ...
    _createClass(Pokemon, [{
        ...
        value: function handleClick(e) {
            ...
            var url = "https://pokeapi.co/api/v2/pokemon/" + this.state.userInput + "/";
            getAjaxPromise(url).then(JSON.parse).then(function (response) {

                var name = response.name;
                var frontDefault = response.sprites.front_default;
                ...
                _this2.setState({ frontDefault: frontDefault });
                _this2.setState({ type: type });
                //this.setState({moves: moves});
                _this2.setState({ weight: weight });
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'container' },
                    _react2.default.createElement('img', { src: this.state.frontDefault }),
                    _react2.default.createElement(
                        'div',
                        { className: 'middle' },
                        _react2.default.createElement(
...
_reactDom2.default.render(_react2.default.createElement(
    'div',
    { className: 'pokemon' },
    _react2.default.createElement(Pokemon, null)
